...
export const mediaDataObj = {
    ...
    faqs: [
           ...
           {que:"How can I ensure the authenticity of an NFT?",ans:"To ensure the authenticity of our NFTs ONLY use the official links found on this website or our official accounts on IG and Twitter, always triple check the handle is: @marsrejects"},
           {que:"What is the story behind your collection?", ans:"Our collection is inspired by counterculture and indie/pulp comic book art, the Mars Rejects story explores the struggles of the left behind on Earth, the cast out as Mars Rejects, as they fight against the tyrannical rulers on Mars."},
           {que:"Who's behind the creation of the collection?",ans:"Our team is initially formed by Pepe Torrado (PFP art and visual design) and Josh Seff (marketing and community), with the collaboration of Pablo Alcalde (comic book artist). We are open to growing our team, if you're interested in collaborating with us, please email us at info@marsrejects.com!"},
           {que:"Are there events planned for the collection?", ans:"Yes, we plan to host events and exhibitions to showcase our collection and engage with the community."},
